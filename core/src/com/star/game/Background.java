...
public class Background {
    ...
    private class Star {
        ...
        public void update(float dt) {
            position.x += (velocity.x - game.getHero().getLastDisplacement().x * 7.5f) * dt;
            position.y += (velocity.y - game.getHero().getLastDisplacement().y * 7.5f) * dt;
            if (position.x < -20){
